...
namespace OnlyShare.Migrations
{
    ...
    [Migration("20230427151757_VotesUpdated")]
    partial class VotesUpdated
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OnlyShare.Database.Models.WeatherForecast", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("eb88cd47-3863-4e75-9474-40f170a6bde8"),
                            Date = new DateTime(2021, 4, 27, 17, 17, 57, 832, DateTimeKind.Local).AddTicks(8900),
                            Summary = "Weather 1",
                            TemperatureC = 30
                        },
                        new
                        {
                            Id = new Guid("99ada259-7976-4d33-9d0a-55552197b2ae"),
                            Date = new DateTime(2022, 4, 27, 17, 17, 57, 832, DateTimeKind.Local).AddTicks(8971),
                            Summary = "Weather 2",
                            TemperatureC = 35
                        },
                        new
                        {
                            Id = new Guid("e655d329-5e2e-49bd-8d6c-32a3aafcdefa"),
                            Date = new DateTime(2023, 4, 27, 17, 17, 57, 832, DateTimeKind.Local).AddTicks(8983),
                            Summary = "Weather 3",
                            TemperatureC = 40
                        });
                });
